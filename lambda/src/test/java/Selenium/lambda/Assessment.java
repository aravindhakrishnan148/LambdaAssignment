...
public class Assessment {
	...
	public RemoteWebDriver driver = null;
	   String username = "aravindkrish148";
		String accessKey = "gv8fJqzvNbosQ1FvoNZx0h1SVeRqnasg0VClzPFAPsee1cZrJo";
		WebDriverWait wait;
...
//	        System.setProperty("webdriver.gecko.driver", "/Users/aravindhak/eclipse-workspace/driver/geckodriver");
//			driver = new FirefoxDriver();
		...
		public void testScript() throws MalformedURLException, IOException  {
						...
						if(driver.getCapabilities().getBrowserName()=="chrome")
						...
						js.executeScript("arguments[0].scrollIntoView(true);", driver.findElement(By.id("preferred-payment")));
				        ...
				        js.executeScript("window.open('https://www.lambdatest.com/selenium-automation/', '_blank');");
